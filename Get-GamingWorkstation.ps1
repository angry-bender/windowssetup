#Installs Packages
choco install firefox microsoft-edge vmwareworkstation 7zip steam goggalaxy origin uplay epicgameslauncher vlc vscode nvidia-display-driver battle.net intel-chipset-device-software intel-me-drivers logitechgaming sysmon citrix-workspace adobereader naps2 git signal putty winscp
