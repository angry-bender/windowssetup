#Installs Packages
choco install firefox vmwareworkstation 7zip vlc vscode nvidia-display-driver intel-chipset-device-software intel-me-drivers sysmon citrix-workspace foxitreader naps2 git signal putty winscp
